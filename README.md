...
| ---- | --------- | ----------------------------------------------------  | -------------- | ----------- |
| 1    | 6/19      | 킥오프      |       |             |
| 2    |6/26| 1. 리액트 훅을 이용한 마이크로 상태 관리 | 이대진 |             |
| 3    |7/10| 2. 지역 상태와 전역 상태 사용하기 ~<br>3. 리액트 컨텍스트를 이용한 컴포넌트 상태 공유 | 이성인 |             |
| 4    |7/24| 4. 구독을 이용한 모듈 상태 공유 ~<br>5. 리액트 컨텍스트와 구독을 이용한 컴포넌트 상태 공유 | 홍현지 |             |
| 5    |7/31| 6. 전역 상태 관리 라이브러리 소개 ~<br>7. 사용 사례 시나리오 1: Zustand | 이정현 |             |
| 6    |8/6| 8. 사용 사례 시나리오 2: Jotai | 김민지 |             |
| 7    |8/13| 9. 사용 사례 시나리오 3: Valtio ~<br>10. 사용 사례 시나리오 4: React Tracked | 나주엽 |             |
| 8    |8/20| 11. 세 가지 전역 상태 라이브러리의 유사점과 차이점 | 유병우 |             |
