...
| 4    |7/17| 4. 구독을 이용한 모듈 상태 공유 ~<br>5. 리액트 컨텍스트와 구독을 이용한 컴포넌트 상태 공유 | 홍현지 |             |
| 5    |7/24| 6. 전역 상태 관리 라이브러리 소개 ~<br>7. 사용 사례 시나리오 1: Zustand | 이정현 |             |
| 6    |7/31| 8. 사용 사례 시나리오 2: Jotai | 김민지 |             |
| 7    |8/7| 9. 사용 사례 시나리오 3: Valtio ~<br>10. 사용 사례 시나리오 4: React Tracked | 나주엽 |             |
| 8    |8/14| 11. 세 가지 전역 상태 라이브러리의 유사점과 차이점 | 유병우 |             |
